export const YoutubeLogo = () => {
    return(
        <svg viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet" focusable="false" className="style-scope yt-icon">
            <g viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet" className="style-scope yt-icon">
